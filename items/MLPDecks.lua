...
SMODS.Back { -- Our Deck
    ...
    apply = function(self, back)
        G.E_MANAGER:add_event(Event({
            func = function()
                local ourdeck_card = pseudorandom_element(G.playing_cards,
                    pseudoseed('lifeissogrand' .. G.GAME.round_resets.ante))
            ...
            func = function()
                for i = 1, 6 do
                    ...
                    local random_enhancement_key = SMODS.poll_enhancement({
                        guaranteed = true,
                        key_append = 'miracleenhance' .. i
                    })
                    local random_seal_key = SMODS.poll_seal({
                        guaranteed = true,
                        key_append = 'miracleseal' .. i
                    })
                    ...
                    local miracledeck_card = pseudorandom_element(basecards,
                        pseudoseed('miraclecard' .. G.GAME.round_resets.ante))
